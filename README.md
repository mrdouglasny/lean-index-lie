...
**5,445 topic-matched declarations** across **4 repositories** (scanned 7 repos, 5,557 declarations).
...
|-----------|:---:|-------------|
| [leanprover-community/mathlib4](https://github.com/leanprover-community/mathlib4) | 5,158 | Mathlib: the math library for Lean 4 |
