...
**5,802 topic-matched declarations** across **4 repositories** (scanned 8 repos, 5,915 declarations).
...
|-----------|:---:|-------------|
| [leanprover-community/mathlib4](https://github.com/leanprover-community/mathlib4) | 5,515 | Mathlib: the math library for Lean 4 |
