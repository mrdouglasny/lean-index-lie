...
**5,815 topic-matched declarations** across **4 repositories** (scanned 9 repos, 5,928 declarations).
...
|-----------|:---:|-------------|
| [leanprover-community/mathlib4](https://github.com/leanprover-community/mathlib4) | 5,528 | Mathlib: the math library for Lean 4 |
