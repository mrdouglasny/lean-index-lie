...
**5,343 topic-matched declarations** across **4 repositories** (scanned 7 repos, 5,455 declarations).
...
|-----------|:---:|-------------|
| [leanprover-community/mathlib4](https://github.com/leanprover-community/mathlib4) | 5,056 | Mathlib: the math library for Lean 4 |
